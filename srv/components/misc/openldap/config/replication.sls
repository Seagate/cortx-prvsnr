...
Configure openldap syncprov_mod:
  cmd.run:
    - name: ldapadd -Y EXTERNAL -H ldapi:/// -f /opt/seagate/generated_configs/ldap/syncprov_mod.ldif

Configure openldap syncprov:
  cmd.run:
    - name: ldapadd -Y EXTERNAL -H ldapi:/// -f /opt/seagate/generated_configs/ldap/syncprov.ldif
    - require:
      - Configure openldap syncprov_mod 
