...
include:
  ...
  - misc_pkgs.kibana.config
  - misc_pkgs.kibana.start
  - misc_pkgs.kibana.sanity_check
...
Kibana already applied:
  test.show_notification:
    - text: "Storage states already executed on node: {{ grains['id'] }}. Execute 'salt '*' state.apply misc_pkgs.kibana.teardown' to reprovision these states."
{% endif %}
