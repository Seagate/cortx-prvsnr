...
include:
  - misc_pkgs.openldap.replication.prepare
  - misc_pkgs.openldap.replication.config
  - misc_pkgs.openldap.replication.sanity_check
...
OpenLDAP replication already applied:
  test.show_notification:
    - text: "OpenLDAP replication states already executed on node: {{ grains['id'] }}. Execute 'salt '*' state.apply misc_pkgs.openldap.teardown' to reprovision these states."
{% endif %}
