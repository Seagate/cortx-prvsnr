...
tar -zcvf eos-prvsnr-cli-${EOS_PRVSNR_VERSION}-git${GIT_VER}.tar.gz eos-prvsnr-cli-${EOS_PRVSNR_VERSION}-git${GIT_VER}
rm -rf eos-prvsnr-cli-${EOS_PRVSNR_VERSION}-git${GIT_VER}

rpmbuild -ba --define "_ees_prvsnr_version ${EOS_PRVSNR_VERSION}"  --define "_ees_prvsnr_git_ver git${GIT_VER}" ${BASEDIR}/eos-prvsnr-cli.spec
