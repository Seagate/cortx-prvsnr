...
include:
  # - system.storage.teardown.tidy-up
...
multipath already applied:
  test.show_notification:
    - text: "multipath states already executed on node: {{ grains['id'] }}. execute 'salt '*' state.apply system.multipath.teardown' to reprovision these states."
{% endif %}
{%- else -%}
