...
{% for filename in [
    ...
    { "src": 'salt://components/misc_pkgs/openldap/files/ssl/enable_ssl_openldap.sh',
      "dest": '/opt/seagate/cortx/provisioner/generated_configs/ldap/enable_ssl_openldap.sh' },
    ...
    { "src": 'salt://components/misc_pkgs/openldap/files/ssl/ssl_certs.ldif',
      "dest": '/opt/seagate/cortx/provisioner/generated_configs/ldap/ssl_certs.ldif' },
