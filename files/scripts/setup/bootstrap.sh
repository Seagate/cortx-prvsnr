...
sudo cp -R /opt/seagate/eos-prvsnr/files/etc/yum.repos.d/* /etc/yum.repos.d/
...
sudo cp /opt/seagate/eos-prvsnr/files/etc/salt/minion /etc/salt/minion
sudo cp /opt/seagate/eos-prvsnr/files/etc/salt/master /etc/salt/master
...
sudo cp /opt/seagate/eos-prvsnr/files/etc/sysconfig/network-scripts/ifcfg-* /etc/sysconfig/network-scripts/
sudo cp /opt/seagate/eos-prvsnr/files/etc/sysconfig/network-scripts/ifcfg-mgmt0 /etc/sysconfig/network-scripts/
sudo cp /opt/seagate/eos-prvsnr/files/etc/sysconfig/network-scripts/ifcfg-data0 /etc/sysconfig/network-scripts/
sudo cp -R /opt/seagate/eos-prvsnr/files/etc/modprobe.d/bonding.conf /etc/modprobe.d/bonding.conf
...
sudo cp /opt/seagate/eos-prvsnr/files/.ssh/id_rsa_prvsnr /root/.ssh/id_rsa
sudo chmod -R 400 /root/.ssh/id_rsa
sudo cp /opt/seagate/eos-prvsnr/files/.ssh/id_rsa_prvsnr.pub /root/.ssh/id_rsa.pub
sudo chmod -R 644 /root/.ssh/id_rsa.pub
sudo cp /opt/seagate/eos-prvsnr/files/.ssh/authorized_keys /root/.ssh/authorized_keys
sudo chmod -R 644 /root/.ssh/authorized_keys
sudo cp /opt/seagate/eos-prvsnr/files/.ssh/known_hosts /root/.ssh/known_hosts
sudo chmod -R 644 /root/.ssh/known_hosts

sudo mkdir -p /etc/salt/pki/master/ssh
sudo chmod -R 755 /etc/salt/pki/master/ssh
sudo cp /opt/seagate/eos-prvsnr/files/.ssh/id_rsa_prvsnr /etc/salt/pki/master/ssh/salt-ssh.rsa
sudo chmod -R 400 /etc/salt/pki/master/ssh/salt-ssh.rsa
sudo cp /opt/seagate/eos-prvsnr/files/.ssh/id_rsa_prvsnr.pub /etc/salt/pki/master/ssh/salt-ssh.rsa.pub
