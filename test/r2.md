...
Steps 1-5 from [EOS-16883] are the same

Consider that SW upgrade ISO bundle is placed by the path
`/root/single_cortx.iso`

Step 6: Check MD5 hash sum:
a) Calculate MD5 hash sum for `single_cortx.iso`

```bash
$ md5sum /root/single_cortx.iso
fefa1db67588d2783b83f07f4f5beb5c  /root/single_cortx.iso
```
...
```bash
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="fefa1db67588d2783b83f07f4f5beb5c"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="fefa1db67588d2783b83f07f4f5beb5c"  --hash-type="md5"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="md5:fefa1db67588d2783b83f07f4f5beb5c"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="md5:fefa1db67588d2783b83f07f4f5beb5c /root/single_cortx.iso"
```

All commands should be succeeded. And output always should be the same as like output in [EOS-16883]: Step-6

Step 7: Check sha256 hash sum:
a) Calculate sha256 hash sum:

```bash
$ sha256sum /root/single_cortx.iso
ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a  /root/single_cortx.iso
```
...
```bash
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a"  --hash-type="sha256"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="sha256:ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="sha256:ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a /root/single_cortx.iso"
```
...
```bash
$ sha512sum /root/single_cortx.iso
ca6cb2dd717bbde5de59ba69b3d5178184e357b706dba87080f0c0801fe34c99efb5ba0e23b7f98b99ce3df209cff287d18214d21fa16288ab6b9ac4194ba14b  /root/single_cortx.iso
```
...
```bash
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="ca6cb2dd717bbde5de59ba69b3d5178184e357b706dba87080f0c0801fe34c99efb5ba0e23b7f98b99ce3df209cff287d18214d21fa16288ab6b9ac4194ba14b"  --hash-type="sha512"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="sha512:ca6cb2dd717bbde5de59ba69b3d5178184e357b706dba87080f0c0801fe34c99efb5ba0e23b7f98b99ce3df209cff287d18214d21fa16288ab6b9ac4194ba14b"
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="sha512:ca6cb2dd717bbde5de59ba69b3d5178184e357b706dba87080f0c0801fe34c99efb5ba0e23b7f98b99ce3df209cff287d18214d21fa16288ab6b9ac4194ba14b /root/single_cortx.iso"
```
...
```bash
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash=/root/hash.data
```

Command should be succeeded. And output should be the same as like output in [EOS-16883]: Step-6
...
```bash
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12b"  --hash-type="sha256"
```

The exception output should be something like that and provisioner should stop command execution:
```
'repo source "/root/single_cortx.iso" is not acceptable, reason: Catalog structure validation error occurred:
"Validation Failed. Reason: Hash sum of file \'/root/single_cortx.iso\': \'ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a\' mismatches the provided one \'ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12b\'"'
```
...
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a"  --hash-type="md5"
...
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a"
...
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso --hash="sha512:ff01da01d4304729bfbad3aeca53b705c1d1d2132e94e4303c1ea210288de12a"
...
```bash
provisioner set_swupgrade_repo 2.0.1 --source=/root/single_cortx.iso
```
