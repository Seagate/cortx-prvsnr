...
def execute_remote_command(cmd_name: str, cmd_args: str, targets: str = ALL_MINIONS,
                           dry_run: bool = False):
    """
    ...
    return _api_call('execute_remote_command', cmd=cmd_name, args=cmd_args, targets=targets,
                     dry_run=dry_run)
