...
"""Defines a module to setup CORTX firewall on system"""
...
class SetupFirewall(CommandParserFillerMixin):
    """Defines logic to setup CORTX firewall on system"""

    input_type: Type[inputs.NoParams] = inputs.NoParams
    _run_args_type = RunArgsEmpty

    def run(self):
        logger.info("Setting up CORTX firewall")
        try:
