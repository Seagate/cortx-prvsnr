...
{%- set openldap_admin_secret = salt['lyveutil.decrypt']('openldap', salt['pillar.get']('cortx:software:openldap:root:secret', "seagate")) %}
{%- set openldap_iam_secret = salt['lyveutil.decrypt']('openldap', salt['pillar.get']('cortx:software:openldap:sgiam:secret', "ldapadmin")) %}
