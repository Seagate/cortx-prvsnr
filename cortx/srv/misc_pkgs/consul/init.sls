...
include:
  ...
  - misc_pkgs.consul.config
  - misc_pkgs.consul.start
  - misc_pkgs.consul.sanity_check
...
Consul already applied:
  test.show_notification:
    - text: "Storage states already executed on node: {{ grains['id'] }}. Execute 'salt '*' state.apply misc_pkgs.consul.teardown' to reprovision these states."
{% endif %}
